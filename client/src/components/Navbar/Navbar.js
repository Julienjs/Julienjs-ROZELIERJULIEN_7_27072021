                ...
                token ? (
                    <nav className={`navbar ${showLinks ? "show-nav" : "hide-nav"}`}>
                        <ul className="nav-links  ">
                            <li>
                                <NavLink onClick={() => setShowLinks(!showLinks)} style={{ textDecoration: 'none', color: 'white' }} exact to='/post'>
                                    <p>Accueil</p>
                            ...
                            {/* {userData.isAdmin ? */}
                            <li>
                                <NavLink onClick={() => setShowLinks(!showLinks)} style={{ textDecoration: 'none', color: 'white' }} exact to='/users'>
                            ...
                            <li onClick={Logout}>
                                <p>Déconnexion</p>
                                <i className="fas fa-power-off" data-tip="Déconnexion"></i>
                            </li>
                            <ReactTooltip
                                place="bottom"
                                type="info"
